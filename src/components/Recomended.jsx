    ...
    return (
        <div className='mt-[65px]'>
            ...
            <div className="container mx-auto py-8 px-6 text-center">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 lg:gap-10">
                 {menuItems.map((item,index) => (
                    <div key={index} className="bg-white p-1 md:p-6 rounded-xl shadow-lg transform hover:scale-105 transition cursor-pointer">
                        <img src={`https://darkslategray-lion-860323.hostingersite.com/food/menuitemimg/${item.image_url}`} alt="pizza" className="w-full h-25  object-cover bg-white rounded-lg" />
